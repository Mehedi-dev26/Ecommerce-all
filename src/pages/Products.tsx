...
const Products = () => {
  ...
  const seoDesc = catLabel
    ? `${catLabel} — Sapahar Mango Shop থেকে সরাসরি বাগানের ১০০% খাঁটি আম। সারাদেশে দ্রুত ডেলিভারি।`
    : "Sapahar Mango Shop-এর সম্পূর্ণ আমের তালিকা — আম্রপালি, হাড়িভাঙা, ফজলি, কাঁঠিমুন। সরাসরি বাগান থেকে খাঁটি আম।";
  const crumbs = [
    { name: "হোম", path: "/" },
