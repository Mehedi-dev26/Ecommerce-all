...
const Contact = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-10">
      ...
      <p className="mb-10 text-center text-muted-foreground">যেকোনো প্রশ্ন বা পরামর্শের জন্য আমাদের সাথে যোগাযোগ করুন</p>
      <div className="grid gap-8 lg:grid-cols-2">
        <div className="space-y-6">
          {[
            { icon: Phone, title: "ফোন", info: "+880 1XXX-XXXXXX" },
            { icon: Mail, title: "ইমেইল", info: "info@mawra.com" },
