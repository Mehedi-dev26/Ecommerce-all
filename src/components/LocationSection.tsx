...
const SHOP_ADDRESS = "সাপাহার উপজেলা, নওগাঁ, রাজশাহী বিভাগ";
// Sapahar Upazila, Naogaon, Bangladesh
const MAP_QUERY = "Sapahar+Upazila,+Naogaon,+Bangladesh";
